...
export function LoaderDialog({ open }: Props) {
  return (
    <Dialog open={open}>
      <DialogContent className="h-84 p-10 sm:max-w-md sm:h-90 sm:p-6 rounded-3xl border-transparent" showCloseButton={false}>
        <img
          src={pinkLine}
